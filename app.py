...
translations = {
    "Français": {
        ...
        "intro_2": "Mécroyance Lab n'est ni un gadget de vérification ni un simple score automatique. C'est un laboratoire de lecture critique.",
        "language": "Langue",
        "settings": "Réglages",
        ...
        "cognitive_vitality": "Vitalité cognitive",
        "mecroyance_index": "Indice de mécroyance",
        "cognitive_triangle": "Triangle cognitif G-N-D",
        "cognitive_triangle_caption": "Le texte est placé dans l'espace de la cognition : savoir articulé, compréhension intégrée, et certitude assertive.",
        "cognitive_metrics": "Métriques cognitives",
        "mendacity_index": "Indice de mendacité (ME)",
        "cognitive_gap": "Écart cognitif (M − ME)",
        "dominant_pattern": "Patron cognitif dominant",
        "pattern_mecroyance": "Patron dominant : mécroyance",
        "pattern_lying": "Patron dominant : mensonge stratégique",
        "pattern_mixed": "Patron dominant : mixte ou ambigu",
        "cognitive_interpretation": "Interprétation cognitive",
        "type_lying": "Possible mensonge stratégique",
        "type_closure": "Haute mécroyance / clôture cognitive",
        "type_sincere": "Cognition probablement sincère mais mal alignée",
        "cognitive_diagnosis_label": "Diagnostic cognitif",
        "diag_strong_mecroyance": "Structure de mécroyance forte",
        "diag_moderate_mecroyance": "Structure de mécroyance modérée",
        "diag_ambiguous": "Structure cognitive ambiguë",
        "diag_deception": "Possible tromperie stratégique",
        "cognitive_tension": "Tension cognitive (mécroyance vs mendacité)",
        "actions_on_articles": "Actions sur les articles trouvés",
        "open_article": "🌐 Ouvrir l'article",
        "load_for_analysis": "📥 Charger pour analyse",
        "article_loaded": "Article chargé dans la zone de texte.",
        "cannot_extract": "Impossible d'extraire le texte.",
        "analysis_zone": "Zone d'analyse",
        "analysis_zone_caption": "Collez un texte, chargez une URL, ou dictez directement.",
        "mic_unavailable": "Microphone indisponible sur cette version.",
        "dictated_text_received": "Texte dicté reçu.",
        "ai_analyzing": "L'IA analyse...",
        "interactive_lab": "Laboratoire interactif de la mécroyance",
        "interactive_lab_caption": "Expérimentez la formule cognitive : M = (G + N) − D. Modifiez les paramètres pour observer l'évolution des stades cognitifs.",
        "current_stage": "Stade actuel",
        "cognitive_evolution": "Évolution cognitive",
        "cognitive_evolution_note": "Lorsque G et N augmentent sans inflation de D, la cognition gagne en revisabilité.",
        "stage_closure": "Fermeture cognitive",
        "stage_closure_desc": "La certitude dépasse la compréhension : la pensée se verrouille.",
        "stage_childhood": "Enfance cognitive",
        "stage_childhood_desc": "Structure cognitive naissante, encore fragile.",
        "stage_adolescence": "Adolescence cognitive",
        "stage_adolescence_desc": "Cognition stable mais encore agitée.",
        "stage_maturity": "Maturité cognitive",
        "stage_maturity_desc": "Équilibre entre savoir, expérience et doute.",
        "stage_wisdom": "Sagesse structurelle",
        "stage_wisdom_desc": "État rare d'équilibre cognitif.",
        "stage_asymptote": "Asymptote de vérité",
        "stage_asymptote_desc": "Horizon théorique de cohérence maximale.",
    },
}
